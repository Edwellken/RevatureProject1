...
namespace FIFAPI.Controllers
{
    ...
    public class TeamsController : ControllerBase
    {
        ...
        public TeamsController(FifaAPIdbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Team>> GetTeam(string name)
        {
          if (_context.Teams == null)
          {
            ...
            var team = await _context.Teams.SingleOrDefaultAsync(a => a.TeamName == name);
        ...
        public async Task<ActionResult<Team>> PostTeam(Team team)
        {
          if (_context.Teams == null)
          {
              return Problem("Entity set 'FifaAPIdbContext.Teams'  is null.");
          }
